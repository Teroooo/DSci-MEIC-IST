...
from utils.dslabs_functions import plot_evaluation_results, read_train_test_from_files


file_tag = "traffic accidents"
train_filename = "../../classification/traffic_final_train.csv"
test_filename = "../../classification/traffic_final_test.csv"
target = "crash_type"
...
savefig(f"images/traffic_final/{file_tag}_nb_{eval_metric}_study.png")
show()

figure()
best_model, params = naive_Bayes_study(trnX, trnY, tstX, tstY, "recall")
savefig(f"images/traffic_final/{file_tag}_nb_recall_study.png")
show()
...
savefig(f'images/traffic_final/{file_tag}_{params["name"]}_best_{params["metric"]}_eval.png')
show()