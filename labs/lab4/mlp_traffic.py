...
savefig(f"images/traffic_final/MLP/{file_tag}_mlp_{eval_metric}_study.png")
show()
...
savefig(f'images/traffic_final/MLP/{file_tag}_mlp_{params["name"]}_best_{params["metric"]}_eval.png')
show()
...
savefig(f"images/traffic_final/MLP/{file_tag}_mlp_{eval_metric}_overfitting.png")
...
savefig(f"images/traffic_final/MLP/{file_tag}_mlp_{eval_metric}_loss_curve.png")
