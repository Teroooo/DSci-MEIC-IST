...
In Dataset 2, after removing leakage-prone columns, several variables initially contained missing values (e.g., DepTime) and were removed. Only one variable with missing values remained, corresponding to approximately 23k records out of more than 4 million in class 0, making missing values extremely rare. Due to the large dataset size, sampling was applied, and the probability of selecting those few records was very low; as a result, the final sample contained no missing values. Therefore, imputation was not required and no method (filling or dropping) had any effect on the dataset.


\begin{figure}[H]
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/MV/traffic_mvi_drop_eval.png}
\caption{Drop}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/MV/traffic_mvi_impute_eval.png}
\caption{Impute}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/MV/mv.png}
\caption{Heatmap: No missing values}
\end{subfigure}
\bigskip
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/MV/MV_eval_1.png}
\caption{Filling imputation (no change)}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/MV/MV_eval_2.png}
\caption{Dropping rows (no change)}
\end{subfigure}
\caption{Missing values analysis and imputation attempts for dataset 2 (no missings detected)}
\end{figure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/Outliers/traffic_outliers_remove_eval.png}
\caption{Drop outliers}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/Outliers/traffic_outliers_keep_eval.png}
\caption{Keep outliers}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/Outliers/Outliers_drop.png}
\caption{Drop outliers (selected)}
\end{subfigure}

\bigskip

\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/Outliers/Outliers_replacing.png}
\caption{Replace with median}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/Outliers/Outliers__truncate.png}
\caption{Truncate}
\end{subfigure}
\caption{Impact of different outlier treatments on NB and KNN performance for dataset 2}
\end{figure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{traffic_accidents/data_preparation/Scaling/traffic_scaling_minmax_eval.png}
\caption{MinMaxScaler}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{traffic_accidents/data_preparation/Scaling/traffic_scaling_standard_eval.png}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{Combined_Flights_2022/data_preparation/Scaling/Scalling_minMAX.png}
\caption{MinMaxScaler (selected)}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering
\includegraphics[width=0.8\textwidth]{Combined_Flights_2022/data_preparation/Scaling/Scalling_ABS.png}
\caption{ABSScaler}
\end{subfigure}
\caption{Scaling results with different approaches (NB and KNN performance) for dataset 2}
\end{figure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/Balancing/traffic_balancing_under_eval.png}
\caption{Random Undersampling}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/Balancing/traffic_balancing_smote_eval.png}
\caption{SMOTE}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/Balancing/Balancing_Under_eval.png}
\caption{Random Undersampling (selected)}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/Balancing/Balancing_Over_eval.png}
...
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/Balancing/Balancing_SMOTE_eval.png}
\caption{SMOTE}
\end{subfigure}
\caption{Balancing results with different approaches (NB and KNN performance) for dataset 2}
\end{figure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/FeatureSelection/var_study.jpeg}
\caption{Redundant variables removal}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/FeatureSelection/traffic_selection_correlation_eval.png}
\caption{Variance Evaluation(variance threshold study)}
\end{subfigure}
\bigskip
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/FeatureSelection/traffic_selection_variance_plot.png}
\caption{Variance Evaluation plot}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/FeatureSelection/red_study.png}
\caption{Redundant variables removal (correlation matrix/threshold)}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/FeatureSelection/FS_high_corr.png}
\caption{Relevant variables selection (variance threshold study)}
\end{subfigure}
\caption{Feature selection results for redundant and low-variance variables in dataset 2}
\end{figure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/FeatureSelection/var_study2.jpeg}
\caption{Redundant variables removal}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/traffic_accidents/data_preparation/FeatureSelection/traffic_selection_variance_eval.png}
\caption{Variance Evaluation(variance threshold study)}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/FeatureSelection/var_study.png}
\caption{Redundant variables removal (correlation matrix/threshold)}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{images/Combined_Flights_2022/data_preparation/FeatureSelection/FS_drop.png}
\caption{Relevant variables selection (variance threshold study)}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{traffic_accidents/models_eval/NB/traffic accidents_nb_accuracy_study.png}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{traffic_accidents/models_eval/NB/traffic accidents_nb_recall_study.png}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{Combined_Flights_2022/models_eval/NB/Combined_flight_v1_nb_accuracy_study.png}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\centering\includegraphics[width=\textwidth]{Combined_Flights_2022/models_eval/NB/Combined_flight_v1_nb_recall_study.png}
\end{subfigure}
\caption{Na{\"i}ve Bayes alternatives comparison for dataset 2}
\end{figure}
...
Logistic Regression proves robust to parameter changes, showing flat accuracy across iterations for both regularizers. In Dataset 1, mild overfitting occurs (Train>Test). 
The best model (l1, 500 iter) achieves 0.65 accuracy, driven primarily by first\_crash\_type and damage. 

In Dataset 2, the model biases heavily toward the majority class, achieving 0.70 accuracy but failing to capture Class 1 (poor recall). 
Distance and CRSElapsedTime are the top predictors.
...
Random forests improve steadily in both datasets.In Dataset~1, accuracy increases quickly and stabilizes. The best model (depth~5, feature fraction~0.5, 750 trees) reaches 0.72 test accuracy with balanced metrics.In Dataset~2, performance remains stable across configurations.The best configuration (max depth~7, feature fraction~0.7, 500 trees) achieves 0.75 test accuracy, with strong precision (0.86) but lower recall (0.60).
\begin{figure}[H]
...
In Dataset 1, 'constant' and 'adaptive' schedules stabilize quickly, while 'invscaling' struggles. Mild overfitting is evident as training accuracy exceeds testing. The best model (constant, lr=0.5) achieves 0.71 accuracy; however, the loss curve plateaus early, resulting in high Recall (0.75) but lower Precision due to False Positives. Dataset 2 converges smoothly with minimal overfitting. The best model (constant, lr=0.5, 3000 iter) reaches 0.79 accuracy, showing balanced metrics and a healthy, convex loss curve.
...
The modeling phase revealed distinct performance patterns across both datasets. In Dataset 1 (Traffic Accidents), the Decision Tree (0.74) and Random Forest (0.72) models emerged as the most balanced, while Naïve Bayes and Logistic Regression struggled with accuracies near 0.65. Key variables like crash\_type and damage were consistently identified as primary predictors across multiple classifiers.
...
Preparation tasks had a moderate impact on performance. The alignment of BernoulliNB with binary features and the success of Manhattan distance in KNN suggest that the initial feature encoding was beneficial for high-dimensional sparsity. 

The models developed for Dataset 1 are promising, showing balanced Precision and Recall, though they may require further feature engineering to break the 0.75 accuracy ceiling. For Dataset 2, despite high accuracy scores (up to 0.97), the models are currently not sufficient for real-world application due to poor Recall on the minority class. While the MLP shows the healthiest learning curve, the overall framework requires better handling of class imbalance before it can be considered a robust solution for flight cancellation forecasting.
